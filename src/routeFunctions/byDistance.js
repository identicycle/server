...
export default { //get shortest path by choosing the closest node to the destination
  shortest: (originID, destinationID, intersectional_node_data, connection, gx) => {
    ...
    while(!found) {
      ...
      let connectedNodes = [];
      connections.forEach((connection) => {//delete all connections to the node from conections
